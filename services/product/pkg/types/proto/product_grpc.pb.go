...
type ProductServiceClient interface {
	CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*IDMessage, error)
	GetAllProducts(ctx context.Context, in *GetAllProductsRequest, opts ...grpc.CallOption) (*GetAllProductsResponse, error)
	GetProductByID(ctx context.Context, in *IDMessage, opts ...grpc.CallOption) (*Product, error)
}
...
func (c *productServiceClient) CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*IDMessage, error) {
...
func (c *productServiceClient) GetProductByID(ctx context.Context, in *IDMessage, opts ...grpc.CallOption) (*Product, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Product)
...
type ProductServiceServer interface {
	CreateProduct(context.Context, *CreateProductRequest) (*IDMessage, error)
	GetAllProducts(context.Context, *GetAllProductsRequest) (*GetAllProductsResponse, error)
	GetProductByID(context.Context, *IDMessage) (*Product, error)
...
func (UnimplementedProductServiceServer) CreateProduct(context.Context, *CreateProductRequest) (*IDMessage, error) {
...
func (UnimplementedProductServiceServer) GetProductByID(context.Context, *IDMessage) (*Product, error) {
...
func _ProductService_GetProductByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProductByID(ctx, req.(*IDMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/product/pkg/types/proto/product.proto",
}
