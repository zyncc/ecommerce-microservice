...
func (h *InventoryEventHandler) Setup(sarama.ConsumerGroupSession) error {
	return nil
}

func (h *InventoryEventHandler) Cleanup(sarama.ConsumerGroupSession) error {
	return nil
}

func (h *InventoryEventHandler) ConsumeClaim(session sarama.ConsumerGroupSession, claim sarama.ConsumerGroupClaim) error {
	for {
		select {
...
func (h *InventoryEventHandler) processMessage(ctx context.Context, msg *sarama.ConsumerMessage) error {
	switch msg.Topic {
...
func (c *InventoryConsumer) RunInventoryConsumer(ctx context.Context) error {
